...
class FoodDatabaseHandler:
    ...
    #         data_params.extend([results_per_page, offset])
...
class RecipeDatabaseHandler:
    ...
    #     # cleaned_words = clean_query(query)
    #     # if not cleaned_words and not filters:
    #     #     return None
    ...
    def get_all_filters(self):
        ...
        try:
            ...
            filters['countries'] = [row[0] for row in curr.fetchall()] or None
